...
<body class="off-canvas-sidebar">
  ...
  <!-- End Google Tag Manager (noscript) -->
    ...
    <div class="wrapper wrapper-full-page">
            <div class="full-page login-page" filter-color="black" data-image="/public/assets/img/login.jpg">
        <!--   you can change the color of the filter page using: data-color="blue | purple | green | orange | red | rose " -->
        <div class="content">
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-4 col-sm-offset-3">
                        <form method="post" id="loginForm" action="javascript:void(0)">
                            <div class="card card-login card-hidden">
                                <div class="card-header text-center" data-background-color="rose">
                                    <h4 class="card-title">TRASI | Login</h4>
                                ...
                                <div class="footer text-center">
                                    <button type="submit" onclick="login()" class="btn btn-rose btn-simple btn-wd btn-lg">Let's go</button>
