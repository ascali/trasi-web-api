...
<!-- Mirrored from demos.creative-tim.com/bs3/material-dashboard-pro/examples/pages/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Jul 2018 04:44:38 GMT -->
        ...
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                ...
                <div class="card card-signup">
                    <h2 class="card-title text-center">Register New User Citizens</h2>
                    <div class="row">
...
<!--                             <div class="social text-center">
                            ...
                            <form class="form" method="post" id="form" action="javascript:void(0)">
                                <div class="card-content">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="longname" id="longname" placeholder="Last Name..." required="">
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input type="checkbox" name="optionsCheckboxes" id="optionsCheckboxes" required="">
                                            I agree to the <a href="#something">terms and conditions</a>.
                                        </label>
                                    </div>
                                </div>
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-primary btn-round" onclick="save()">Get Started</button>
                                </div>
                            </form>
                        </div>
                    </div>
...
<!-- Mirrored from demos.creative-tim.com/bs3/material-dashboard-pro/examples/pages/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 01 Jul 2018 04:44:39 GMT -->
</html>
